...
Return a JSON object with any of these optional fields:
{
  ...
  "minCurrentPrice": number or null,
  "maxCurrentPrice": number or null,
  "minBookValue": number or null,
  "maxBookValue": number or null,
  "minIntrinsicValue": number or null,
  "maxIntrinsicValue": number or null,
  "minGrahamNumber": number or null,
  "maxGrahamNumber": number or null,
  "maxPE": number or null,
  "minPE": number or null,
  "minROE": number (percentage) or null,
  "minROCE": number (percentage) or null,
  "minDebt": number or null,
  "maxDebt": number or null,
  "priceBelowGraham": boolean or null,
  "priceBelowIntrinsic": boolean or null,
  ...
  "minCurrentRatio": number or null,
  "minQuickRatio": number or null,
  "maxPEG": number or null,
  "maxEVEbitda": number or null,
  "minPromoterHolding": number or null,
  "minFiiHolding": number or null,
  "minDiiHolding": number or null,
  "minEPS": number or null,
  "maxNetDebt": number or null,
  "minFreeCashFlow3yr": number or null,
  "minHigh52w": number or null,
  "maxLow52w": number or null,
